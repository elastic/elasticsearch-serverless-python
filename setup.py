...
packages = [
    package
    for package in find_packages(where=".", exclude=("test_elasticsearch_serverless*",))
...
setup(
    ...
    license="Apache-2.0",
    url="https://github.com/elastic/elasticsearch-serverless-python",
    ...
    packages=packages,
    package_data={"elasticsearch_serverless": ["py.typed", "*.pyi"]},
