...
class XPackClient(NamespacedClient):
    ...
    async def info(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/generated/info-api.html>`_
    ...
    async def usage(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/generated/usage-api.html>`_
